...
def main():
    ...
    st.markdown("<h1 style='color: #19105B; padding:0;'>Portfolio Company 1</h1>", unsafe_allow_html=True)
    st.divider()
    ...
    # comments = [generate_random_string() for _ in range(43)]
    # assumptions[["Low Case" ,"Base Case" ,"High Case" ,"Comments"]] = sample_values
    ...
    with st.container(border=True):
        ...
        netdebt_and_cashflow_df_pf1['Low Case'] = [5,9]
        netdebt_and_cashflow_df_pf1['Base Case'] = [10, 12]
        netdebt_and_cashflow_df_pf1['High Case'] = [9, 8]
    ...
    with col2:
        st.markdown("<h2 style='color: #19105B; font-size:28px;' class='streamlit-tooltip'>Returns Calculations<span class='tooltiptext'>View the return calculations value</span></h2>", unsafe_allow_html=True)
    ...
    with st.container(border=True):
        ...
        st.markdown("<h2 style='color: #19105B; font-size:28px;'class='streamlit-tooltip'>Valuation Waterfall <span class='tooltiptext'>View the PortCo 1 Valuation Waterfall chart</span></h2>", unsafe_allow_html=True)
