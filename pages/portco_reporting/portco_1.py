...
def main():
    ...
    with st.container(border=True):
        ...
        column_values_list = ss.investments_data_pf1['Scenario'].tolist()
        column_values_values = ss.investments_data_pf1['EBITDA at Exit'].tolist()
        column_values_values2 = ss.investments_data_pf1['Multiple at Exit'].tolist()
        ...
        netdebt_and_cashflow_df_pf1['Low Case'] = [120, 119]
        netdebt_and_cashflow_df_pf1['Base Case'] = [128, 126]
        netdebt_and_cashflow_df_pf1['High Case'] = [112, 110]
