...
def main():
    ...
    # Header
    st.markdown("<h1>Portfolio Company 2</h1>", unsafe_allow_html=True)
    ...
    def fetching_assumptions_data():
        ...
        ss.investments_data_pf2.loc[ss.investments_data_pf2['Scenario'] == 'Invested Amount', 'Low Case'] = abs(low_case_sum_of_negatives)
        ss.investments_data_pf2.loc[ss.investments_data_pf2['Scenario'] == 'Invested Amount', 'Base Case'] = abs(base_case_sum_of_negatives)
        ss.investments_data_pf2.loc[ss.investments_data_pf2['Scenario'] == 'Invested Amount', 'High Case'] = abs(high_case_sum_of_negatives)
    ...
    with st.container(border=True):
        ...
        with col1:
            with st.container(height=230, border=True):
                ...
                with input_col1:
                    ...
                    if lowcase_enddate < ss.min_date_pf2 and ss.flagging_pf2 == True:
                ...
                with input_col2:
                    ...
                    if basecase_enddate < ss.min_date_pf2 and ss.flagging_pf2 == True:
                ...
                with input_col3:
                    ...
                    if 'highcase_enddate_pf2' not in ss and ss.flagging_pf2 == True:
            ...
            with st.container(height=400, border=True): 
                ...
                investments_details_v2 = de(ss.investments_data_pf2, use_container_width=True, height=150, hide_index=True, column_order=["Scenario", "Low Case", "Base Case", "High Case"],  disabled=["Scenario"])
        ...
        column_values_values, column_values_values2 =  get_ebitda_and_multiple(ss.investments_data_pf2)
        ...
        netdebt_and_cashflow_df_pf2['Low Case'] = [129,24]
        netdebt_and_cashflow_df_pf2['Base Case'] = [123,22]
        netdebt_and_cashflow_df_pf2['High Case'] = [117,13]
        ...
        with column2:
            ...
            with st.container(height=600, border=True):
                ...
                with tab1:
                    ...
                    editda_multiple_df_pf2_styled_df = de(ss.editda_multiple_df_pf2, width=550, height=105, hide_index=True, disabled=["Calc", "Entry", "Low Case", "Base Case", "High Case"])
                ...
                with tab2:
                    ...
                    netdebt_and_cashflow_edited_df_pf2 = de(ss.netdebt_and_cashflow_df_pf2, width=550, height=105, hide_index=True, disabled=["Calc"])
                ...
                with tab3:
                    ...
                    equity_df_pf2_styled_df = de(ss.equity_df_pf2, width=550, height=70, hide_index=True, disabled=["Calc", "Entry", "Low Case", "Base Case", "High Case"])
                ...
                with tab5:
                    ...
                    value_and_investment_df_pf2_styled_df = de(ss.value_and_investment_df_pf2, width=550, height=105, hide_index=True, disabled=["Calc", "Entry", "Low Case", "Base Case", "High Case"])
                ...
                with tab6:
                    ...
                    money_multiple_df_pf2_styled_df = de(ss.money_multiple_df_pf2, width=550, height=70, hide_index=True, disabled=["Calc", "Entry", "Low Case", "Base Case", "High Case"])
        ...
        with col2:
            ...
            with st.container():
                ...
                st.write(revenue_return_pf2_styled_df.hide(axis="index").set_table_attributes('style="margin: 0 auto;"').to_html(), unsafe_allow_html=True)
        ...
        with st.container(height=650, border=None):
            ...
            waterfall_data_flow_df_pf2['Values'] = waterfall_data_flow_df_pf2['Values'] / 1000
