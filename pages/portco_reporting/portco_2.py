    ...
    with st.container(border=True):
        ...
        with col1:
            ...
            with st.container(height=400, border=True): 
                ...
                investments_details_v2 = de(ss.investments_data_pf2, use_container_width=True, height=150, hide_index=True, column_order=["Scenario", "Invested Amount", "EBITDA at Exit", "Multiple at Exit"],  disabled=["Scenario", "Invested Amount"])
        ...
        column_values_list = ss.investments_data_pf2['Scenario'].tolist()
        column_values_values = ss.investments_data_pf2['EBITDA at Exit'].tolist()
        column_values_values2 = ss.investments_data_pf2['Multiple at Exit'].tolist()
