...
def main():
    ...
    if not ss.investments_data_pf3.equals(investments_details_v2):
        ...
        ss.assumptions_data_pf3[["Low Case" ,"Base Case" ,"High Case"]] = None
    ...
    with st.container(border=True):
        st.markdown("<h2 style='color: #19105B; font-size:28px;' class='streamlit-tooltip'>Waterfall Chart <span class='tooltiptext'>Can View the Waterfall Chart for PortCo 3</span></h2>", unsafe_allow_html=True)
        ...
        if ss.selected_option_pf3 in waterfall_data_pf3.columns:
            case_value = waterfall_data_pf3.loc[waterfall_data_pf3['Calc'] == 'ARR /Rev /EBITDA', ss.selected_option_pf1].values
            if case_value == None:
                case_value = 0
